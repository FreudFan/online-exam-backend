...
public class SubjectDao {
    ...
    public List<Subject> getAll() {
        ...
        return (List) MapUtil.mapToObject(mapList, Subject.class);
    }
    ...
    public List<Subject> getSubjectsByOrgId(Integer orgId) {
        ...
        List<Map<String, Object>> map = jdbcTemplate.queryForList(sql, new Object[]{orgId});
        return (List) MapUtil.mapToObject(map, Subject.class);
    }
